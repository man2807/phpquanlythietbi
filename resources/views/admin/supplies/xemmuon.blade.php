            ...
            <div class="content_top">
                <div class="filter flex">
                    <div class="filter-left ">
                        ...
                        <button id='tra' class="btn btn-primary">Trả thiết bị</button>
                    </div>
                        ...
                        @foreach($supplie as $item)
                            <div class="product_list_item col-lg-4">
                                <tr>
                                    ...
                                    <input class='sltra3' value="{{ $item->idtb }}" type="hidden">
                                    <input class='sltra2' value="{{ $item->idchitietmuon }}" type="hidden">
                                    <td><input class='sltratot' id= "input"  name="sltt" type="number" value="0" min="0" max="{{ $item->soluongmuon }}"></input></td>
                                    <td><input class='sltrahong' id= "input"  name="slth" type="number" value="0" min="0" max="{{ $item->soluongmuon }}"></input></td>
                                </tr>
                            </div>
                        @endforeach      
                    </tbody>
